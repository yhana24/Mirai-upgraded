...
module.exports.handleReply = async function({ api, event, handleReply }) {
    const permission = [``,``];
	if (!permission.includes(event.senderID)) return api.sendMessage("You don't have permission to use this command only AdMiN Bot", event.threadID, event.messageID);
