...
module.exports.run = async ({ api, event, args }) => {
    ...
    const bgtext = args[3];
            ...
            let getAvatar = (await axios.get(`https://manhict.tech/api/avtWibu6?id=${id}&tenchinh=${name}&tenphu=${juswa}&mxh=${bgtext}&apikey=Ff7Xm5h9`, { responseType: "arraybuffer" } )).data; 
