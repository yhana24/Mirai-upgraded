...
module.exports.config = {
  ...
  version: "2.0.0",
  hasPermssion: 0,
  credits: "D-Jukie mod by John Lester",
...
module.exports.run = async function ({ api, event, args, Users }) {
  if ((this.config.credits) != "D-Jukie mod by John Lester") { return api.sendMessage(`Detected credits have been changed`, event.threadID, event.messageID)}
